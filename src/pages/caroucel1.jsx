  ...
  return (
    <div className="relative min-h-screen bg-gray-100 overflow-hidden">
      ...
      <div className="fixed bottom-4 md:bottom-8 left-0 right-0 flex justify-between px-4 md:px-8 z-40">
        <span className="text-xs md:text-sm text-gray-600">CONTACTS</span>
        <span className="text-xs md:text-sm text-gray-600">TERMS OF USE</span>
      </div>
      ...
      >
        <div className="relative w-full h-full max-w-[2000px] mx-auto">
          {images.map((image, index) => (
            ...
            >
              <div className={`relative ${isMobile ? 'w-[200px]' : 'w-[400px] md:w-[500px]'} 
